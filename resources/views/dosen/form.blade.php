...
<head>
    ...
    <title>Formulir Input Jurnal Penelitian dan Jurnal PKM Dosen - USINDO</title>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="radio-group">
                <label><input type="radio" name="form_choice" value="jurnal" onchange="showForm()" {{ old('form_choice_memory') == 'jurnal' ? 'checked' : '' }}> <i class="fas fa-book-open"></i> Jurnal Penelitian </label>
                <label><input type="radio" name="form_choice" value="pkm" onchange="showForm()" {{ old('form_choice_memory') == 'pkm' ? 'checked' : '' }}> <i class="fas fa-lightbulb"></i> Jurnal PKM </label>
            </div>
        </div>

...
<div class="edit-admin-wrapper">
    ...
    <div class="edit-admin-profile">
        ...
        <p class="profile-subtitle">
            Perbarui informasi admin dengan hati-hati. Pastikan data yang dimasukkan akurat dan valid.
        </p>
    </div>
    ...
    <div class="edit-admin-form-area">
        ...
        <p class="edit-subtitle">Perbarui data admin dengan benar dan lengkap.</p>
        ...
        <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
            ...
            <div class="mb-3">
                <label for="password" class="form-label">
                    Password <span class="text-muted">(Kosongkan jika tidak ingin mengubah)</span>
                </label>
                <div class="input-group">

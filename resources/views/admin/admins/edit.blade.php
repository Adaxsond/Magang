...
<style>
    ...
    body, .edit-admin-wrapper, .edit-admin-profile, .edit-admin-form-area {
        overflow-x: hidden;
    }
    .edit-admin-profile {
        min-width: 260px;
    ...
    @media (max-width: 576px) {
        .edit-admin-wrapper { padding: 0.5rem 0.2rem; }
        .edit-admin-profile { flex-direction: column; gap: 10px; align-items: flex-start; }
...
<div class="edit-admin-wrapper">
    ...
    <div class="edit-admin-profile">
        <div>
            ...
            <span class="admin-role">{{ Str::ucfirst($admin->role) }}</span>
        </div>
    </div>
    <div class="edit-admin-form-area">
        <div class="edit-title"><i class="fas fa-user-edit me-2"></i>Edit Admin</div>
        <div class="edit-subtitle">Perbarui data admin dengan benar dan lengkap.</div>
        ...
        <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
            ...
            <div class="input-group-modern">
                ...
                <input type="text" id="name" name="name" class="form-control"
                       value="{{ old('name', $admin->name) }}" required placeholder="Nama lengkap admin">
            ...
            <div class="input-group-modern">
                ...
                <input type="email" id="email" name="email" class="form-control"
                       value="{{ old('email', $admin->email) }}" required placeholder="Alamat email aktif">
            ...
            <div class="input-group-modern">
                <label for="password" class="form-label">Password <span class="text-muted" style="font-weight:400;">(Kosongkan jika tidak ingin mengubah)</span></label>

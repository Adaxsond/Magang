...
@section('content')
<div class="edit-dosen-wrapper">
    {{-- Area Profil --}}
    <div class="edit-dosen-profile">
        <div class="dosen-avatar">
            <i class="fas fa-user-edit"></i>
        </div>
        <h3 class="profile-title">Edit Data Dosen</h3>
        <p class="profile-subtitle">
            Perbarui data dosen di bawah ini dengan informasi terbaru yang valid.
        </p>
    </div>

    {{-- Area Formulir --}}
    <div class="edit-dosen-form-area">
        <h2 class="edit-title">Perbarui Informasi Dosen</h2>
        <p class="edit-subtitle">Pastikan seluruh data sudah benar sebelum menyimpan perubahan.</p>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nidn" name="nidn"
                            ...
                            placeholder="Contoh: 0412345678" required>
                    </div>
                    @error('nidn')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email"
                        ...
                        placeholder="Contoh: dosen@kampus.ac.id" required>
                </div>
                @error('email')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
